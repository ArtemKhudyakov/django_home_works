...
class User(AbstractUser):
    ...
    email = models.EmailField(unique=True, blank=False, null=False, verbose_name='email', help_text="Введите адрес электронной почты")
    ...
    avatar = models.ImageField(upload_to='users/avatars', blank=True, null=True, verbose_name='Аватар', help_text="Загрузите изображение аватара")
